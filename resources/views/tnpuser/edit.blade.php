				    	...
				    	<fieldset>
						    ...
						    <div class="col-md-8">
						            ...
						            <div class="content-box-large box-with-header">
								    	...
								    	<div class="form-group">
								    		<label class="col-lg-3 control-label" for="tenthpercent">Tenth Percentage :</label>
								    		<div class="col-lg-4">
								    	...
								    	<div class="form-group">
								    		<label class="col-lg-3 control-label" for="twelthpercent">Twelth Percentage :</label>
								    		<div class="col-lg-4">
								    	...
								    	<div class="form-group">
								    		<label class="col-lg-3 control-label" for="diplomapercent">Diploma Percentage :</label>
								    		<div class="col-lg-4">
